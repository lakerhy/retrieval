...
% 
%************************************************************************* 
function [p,traceS] = inv_funtest(T_A,type) 
...
%   [6V]    [6H]    [10V]   [10H]   [18V]   [18H]   [23V]   [23H]   [37V]   [37H]
  ...
  %**************************************************************************
  T_A_0 = fw_fun2(p0(1),p0(2),p0(3),p0(4),p0(5),p0(6),p0(7),type);
  Delta_T=T_A-T_A_0; 
  
  if max(abs(Delta_T)) < 0.5
    iterate=0;
    p_est=p0;             %Return with p
  else
    iterate=1;
  end
  k=0;
  ...
  while iterate
    ...
    % DT/DT_s
    M(:,1)=(fw_fun2(p(1,1),p(2,3),p(3,3),p(4,3),p(5,3),p(6,3),p(7,3),type)-fw_fun2(p(1,2),p(2,3),p(3,3),p(4,3),p(5,3),p(6,3),p(7,3),type))/(p(1,1)-p(1,2));
    % DT/DW        
    M(:,2)=(fw_fun2(p(1,3),p(2,1),p(3,3),p(4,3),p(5,3),p(6,3),p(7,3),type)-fw_fun2(p(1,3),p(2,2),p(3,3),p(4,3),p(5,3),p(6,3),p(7,3),type))/(p(2,1)-p(2,2));
    % DT/DDi_snow
    M(:,3)=(fw_fun2(p(1,3),p(2,3),p(3,1),p(4,3),p(5,3),p(6,3),p(7,3),type)-fw_fun2(p(1,3),p(2,3),p(3,2),p(4,3),p(5,3),p(6,3),p(7,3),type))/(p(3,1)-p(3,2));
    % DT/DRoi_snow    
    M(:,4)=(fw_fun2(p(1,3),p(2,3),p(3,3),p(4,1),p(5,3),p(6,3),p(7,3),type)-fw_fun2(p(1,3),p(2,3),p(3,3),p(4,2),p(5,3),p(6,3),p(7,3),type))/(p(4,1)-p(4,2));
    % DT/DPci_snow    
    M(:,5)=(fw_fun2(p(1,3),p(2,3),p(3,3),p(4,3),p(5,1),p(6,3),p(7,3),type)-fw_fun2(p(1,3),p(2,3),p(3,3),p(4,3),p(5,2),p(6,3),p(7,3),type))/(p(5,1)-p(5,2));
    % DT/DDi_ice    
    M(:,6)=(fw_fun2(p(1,3),p(2,3),p(3,3),p(4,3),p(5,3),p(6,1),p(7,3),type)-fw_fun2(p(1,3),p(2,3),p(3,3),p(4,3),p(5,3),p(6,2),p(7,3),type))/(p(6,1)-p(6,2));
    % DT/Dsal    
    M(:,7)=(fw_fun2(p(1,3),p(2,3),p(3,3),p(4,3),p(5,3),p(6,3),p(7,1),type)-fw_fun2(p(1,3),p(2,3),p(3,3),p(4,3),p(5,3),p(6,3),p(7,2),type))/(p(7,1)-p(7,2));
    %**********************************************************************
    ...
    T_A_estimated=fw_fun2(p(1,3),p(2,3),p(3,3),p(4,3),p(5,3),p(6,3),p(7,3),type);
