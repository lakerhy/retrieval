...
%       Tb_FY_memls=icemain(55,0.5,0.5,FY,0,0,11);
      ...
      Tb_FY_memls=icemain_new('Freq-Memls-in.txt','Angl-Memls-in.txt', FY,3);
      ...
      for i = 1:5
        ...
        [Tbv(:,i),Tbh(:,i)] = epsdepth(freq,epsi1(i),epsii1(i),epsi2(i), ...
                                       epsii2(i));
        cd ../MEMLS
      end
    end
...
%      Tb_MY_memls=icemain(55,0.5,0.5,MY,0,0,11);
 Tb_MY_memls=icemain_new('Freq-Memls-in.txt','Angl-Memls-in.txt', MY,4);
